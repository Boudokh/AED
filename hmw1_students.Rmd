...
```{r}
# TODO:
data_f = readr::read_delim(paste("LIFE_TABLES/",country_code[country],".fltper_1x1.txt",sep=""), delim=" ")
data_m = readr::read_delim(paste("LIFE_TABLES/",country_code[country],".mltper_1x1.txt",sep=""), delim=" ")
data_b = readr::read_delim(paste("LIFE_TABLES/",country_code[country],".bltper_1x1.txt",sep=""), delim=" ")
...
p<- data_f %>%
  ...
  ggplot(mapping=aes(x=mx, y=Age, colour=Year, size=pop)) +
  geom_point() +
  #'facet_grid(~ Year) +
